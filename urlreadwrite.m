...
if (userInfo.length()>0)
    userInfoJava=java.lang.String(userInfo);
    enc=sun.misc.BASE64Encoder;
    userInfoEnc=char(enc.encodeBuffer(userInfoJava.getBytes));
    urlConnection.setRequestProperty('Authorization',['Basic ', userInfoEnc(1:end-1)]);
end;
